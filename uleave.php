            ...
            <form action="#">
                ...
                <div class="user-details">
                    <div class="input-box">
                        ...
                        <input type="text" placeholder="Enter your Leave type" required />
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text" placeholder="Enter your Starting Date" required />
                    </div>
                    <div class="input-box">
                        <span class="details">End Day</span>
                        <input type="text" placeholder="Enter your Ending Date" required />
                    </div>
                    <div class="check-box">
                        <input type="checkbox" />
                        <span class="details">Is it a Half day ?</span>
                    </div>
                    <div class="button1">
